...
if __name__ == '__main__':
    ...
    gmail_send_message(FROM = 'artxandahotel@gmail.com' , TO ="ecampbelldsp@gmail.com", attachment_filename = "C:/Opencheck/tmp/4641.zip", message_text = "Automatic draft message", subject="TEST")